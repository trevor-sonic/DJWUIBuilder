...
final class UIButtonBuilder:UIViewBuilder {
    ...
    func imageAndTextPos(_ pos:Position = .iconLeftTextLeft)->Self{
    ...
    func font(size:CGFloat, weight:UIFont.Weight)->Self{
    ...
    func inset(top: CGFloat = 5, left: CGFloat = 5, bottom: CGFloat = 5, right: CGFloat = 5)->Self{
    ...
    override func buildAndAdd(on view: UIView)->UIButton {
